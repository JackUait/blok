...
const FEATURES: FeatureDetail[] = [
  {
    ...
    description: (
      <>
        Content is structured as <strong>typed JSON blocks</strong>, not raw
        HTML. Parse, store, and render anywhere.
      </>
    ),
    accent: "coral",
    details: {
...
new Blok({
  ...
  },
  {
    ...
    description: (
      <>
        Select text to format with <strong>bold</strong>, <em>italic</em>, and
        links. Extensible with custom inline tools.
      </>
    ),
    accent: "pink",
    details: {
...
new Blok({
  ...
  },
  {
    ...
    description: (
      <>
        Extend the editor with <strong>custom blocks</strong>. Built-in
        paragraph, header, list tools included.
      </>
    ),
    accent: "green",
    details: {
  ...
  },
  {
    ...
    description: (
      <>
        Toggle read-only mode <strong>at runtime</strong>. Perfect for view-only
...
console.log(editor.readOnly.isEnabled);`,
  ...
  },
  {
    ...
    description: (
      <>
        Lazy-loaded i18n with <strong>RTL support</strong>. Only English bundled
