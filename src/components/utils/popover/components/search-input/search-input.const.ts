...
export const css = {
  ...
  input: "text-sm outline-hidden font-medium font-inherit border-0 bg-transparent m-0 p-0 leading-[20px] min-w-[calc(100%-(--spacing(6))-6px)] text-text-primary placeholder:text-search-input-placeholder placeholder:font-normal",
};
