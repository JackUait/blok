...
export type BlokMessageKey =
  ...
  | 'popover.search'
  | 'presence.anonymous.asteroid'
  | 'presence.anonymous.astronaut'
  | 'presence.anonymous.comet'
  | 'presence.anonymous.galaxy'
  | 'presence.anonymous.moon'
  | 'presence.anonymous.planet'
  | 'presence.anonymous.rocket'
  | 'presence.anonymous.satellite'
  | 'presence.anonymous.saucer'
  | 'presence.anonymous.star'
  | 'presence.anonymous.sun'
  | 'presence.anonymous.telescope'
  | 'presence.anonymous.unknown'
  ...
  | 'toolbox.sectionAdvanced'
  | 'toolbox.sectionBasic'
