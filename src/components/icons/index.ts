...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5m4 4.75 2.5-1.75V15"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5m7.5 10H14c0-3.25 3.5-2.5 3.5-5 0-1.25-1.75-2-3.5-.75"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5m4.5 3.75c1.5-.85 3-.01 3 1.25 0 .44-.18.87-.49 1.18-.31.31-.74.49-1.18.49.44 0 .87.18 1.18.49.31.31.49.74.49 1.18 0 1.5-1.75 2.5-3.5 1.25"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5M14 8.25v2.6c0 .22.09.43.24.59.16.15.37.24.59.24h2.67M17.5 8.25V15"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5M17.5 8.25H14v2.6h1.25c1.25 0 2.25.9 2.25 2.05 0 1.15-1 2.1-2.25 2.1-.42 0-.75-.08-1.08-.25"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M3.5 10H10M3.5 15V5M10 15V5m4 8.25c0 .97.78 1.75 1.75 1.75s1.75-.78 1.75-1.75-.78-1.75-1.75-1.75S14 12.28 14 13.25Zm0 0c0-2.1.85-3.4 2.5-5"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="M6.75 10h6.5M6.75 15V5m6.5 10V5"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path
    d="m3.5 2.75 2.5 2.25-2.5 2.25M9 5h8M6 10h11M6 15h11"
    stroke="currentColor"
    stroke-width="1.25"
    stroke-linecap="round"
    stroke-linejoin="round"
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  ...
  <text x="4" y="6" fill="currentColor" font-size="5.5" font-weight="600" font-family="'Helvetica Neue', Arial, sans-serif" text-anchor="middle" dominant-baseline="central">1</text>
  <text x="4" y="11" fill="currentColor" font-size="5.5" font-weight="600" font-family="'Helvetica Neue', Arial, sans-serif" text-anchor="middle" dominant-baseline="central">2</text>
  <text x="4" y="16" fill="currentColor" font-size="5.5" font-weight="600" font-family="'Helvetica Neue', Arial, sans-serif" text-anchor="middle" dominant-baseline="central">3</text>
</svg>
`;
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M10 16V4m0 0-3 3m3-3 3 3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M10 4v12m0 0 3-3m-3 3-3-3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M16 10H4m0 0 3-3M4 10l3 3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M4 10h12m0 0-3-3m3 3-3 3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
// Horizontal dots / more options icon — house more-options glyph;
// IconMoreHorizontal is this geometry scaled to the 24-viewBox overlay chrome.
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M2.5 10H8M2.5 15V5M8 15V5m3 4.75 2.5-1.75V15" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M2.5 10H8M2.5 15V5M8 15V5m6.5 10H11c0-3.25 3.5-2.5 3.5-5 0-1.25-1.75-2-3.5-.75" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M16 7l2.5 3-2.5 3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <path d="M2.5 10H8M2.5 15V5M8 15V5" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M11 8.75c1.5-.85 3-.01 3 1.25 0 .44-.18.87-.49 1.18-.31.31-.74.49-1.18.49.44 0 .87.18 1.18.49.31.31.49.74.49 1.18 0 1.5-1.75 2.5-3.5 1.25" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M16 7l2.5 3-2.5 3" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
// ============================================================================
// Image tool icons (24×24 viewBox, 1.75 stroke) — ONLY for floating overlay
// toolbars and the lightbox (CSS-sized chrome, never rendered beside house
// icons). Never use these inside MenuConfig popovers or labeled menu rows —
// those surfaces mix tools and must stay on the 20×20 / 1.25 house spec.
// ============================================================================
...
export const IconExpandFullscreenImage = wrapImageSvg('<path d="M15 3h6v6"/><path d="M9 21H3v-6"/><path d="m21 3-7 7"/><path d="m3 21 7-7"/>');
export const IconDownloadImage = wrapImageSvg('<path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><path d="M7 10l5 5 5-5"/><path d="M12 15V3"/>');
export const IconCaptionImage = wrapImageSvg('<rect x="3" y="3.5" width="18" height="12" rx="2.5"/><circle cx="7.5" cy="7.5" r="1.2" fill="currentColor" stroke="none"/><path d="m4 13.6 3.4-3.2 2.4 2.2 3.6-3.3 4.4 4"/><path d="M5 19h14"/><path d="M5 22h8"/>');
...
export const IconCropImage = wrapImageSvg('<path d="M6 2v14a2 2 0 0 0 2 2h14"/><path d="M2 6h14a2 2 0 0 1 2 2v14"/>');

// More-options (horizontal 3 dots) — IconDotsHorizontal geometry scaled 24/20
// for overlay chrome (image toolbar, embed overlay); update both together.
export const IconMoreHorizontal = '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false"><circle cx="6" cy="12" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="18" cy="12" r="1.5"/></svg>';
...
export const IconLinkExternal = wrapImageSvg('<path d="M19 13.5V18a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 5 18V9a2.5 2.5 0 0 1 2.5-2.5H12"/><path d="M15.5 4H20v4.5"/><path d="M20 4l-8.5 8.5"/>');
...
// ============================================================================
// House-spec menu icons (20×20 / 1.25) — used in MenuConfig popovers where
// image-spec (24×24 / 1.75) icons would render visibly bolder than neighbours
// ============================================================================
...
// Caption — image panel (sun + ridge) with left-aligned caption lines underneath
...
// Crop — two overlapping crop corners
...
// Expand fullscreen — outward corner arrows
...
// Dice — emoji picker "random" button (14×14; 1.5-at-14 optically matches 1.25-at-20)
export const IconDice = '<svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true" focusable="false"><rect x="1.5" y="1.5" width="11" height="11" rx="2" stroke="currentColor" stroke-width="1.5"/><circle cx="4.5" cy="4.5" r=".9" fill="currentColor"/><circle cx="7" cy="7" r=".9" fill="currentColor"/><circle cx="9.5" cy="9.5" r=".9" fill="currentColor"/></svg>';

// Toggle expand/collapse chevron — 12×12 so it fits the toggle arrow button
export const IconChevronRightSmall = '<svg aria-hidden="true" focusable="false" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.5 2.5L8.5 6L4.5 9.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';
...
export const buildIconColumnsCount = (count: number): string => {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><rect x="${x}" y="${y}" width="${w}" height="${h}" rx="1.5"/>${dividers}</svg>`;
};
