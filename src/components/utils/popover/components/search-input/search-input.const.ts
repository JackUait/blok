...
export const css = {
  ...
  input: "w-full text-[13px] outline-hidden font-normal font-[inherit] border-0 bg-transparent m-0 p-0 leading-[22px] text-text-primary placeholder:text-search-input-placeholder placeholder:font-normal",
};
