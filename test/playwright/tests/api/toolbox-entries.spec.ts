...
const BLOCK_SELECTOR = `${EDITOR_INTERFACE_SELECTOR} [data-testid="block-wrapper"] [contenteditable]`;
const PLUS_BUTTON_SELECTOR = `${EDITOR_INTERFACE_SELECTOR} [data-testid="plus-button"]`;
const POPOVER_ITEM_SELECTOR = `[data-testid=toolbox] [data-testid="popover-item"]`;
const POPOVER_ITEM_ICON_SELECTOR = '[data-testid="popover-item-icon"]';
