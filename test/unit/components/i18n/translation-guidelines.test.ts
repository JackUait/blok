...
const YIDDISH_REVIEWED_EXPECTATIONS: Readonly<Record<string, string>> = {
  'toolNames.bulletedList': 'פּונקטירטע ליסטע',
  'toolNames.numberedList': 'נומערירטע ליסטע',
  'tools.marker.textColor': 'טעקסט־קאָליר',
  'tools.colorPicker.defaultSwatchLabel': '{mode}: {default}',
  'tools.colorPicker.colorSwatchLabel': '{mode}: {color}',
  'tools.toggle.bodyPlaceholder': 'ליידיקער אויפֿקלאַפּ. קליק צו צולייגן אַ בלאָק אָדער שלעפּ בלאָקן אַהער.',
  'tools.table.clearSelection': 'אויסמעקן דעם אינהאַלט',
  'tools.table.placement': 'אויסגלײַכונג',
  'a11y.dragStartedMultiple': 'מען שלעפּט {count} בלאָקן',
  'a11y.blockDuplicated': 'אַ דופּליקאַט פֿונעם בלאָק געשאַפֿן אויף פּאָזיציע {position} פֿון {total}',
  'a11y.blocksDuplicated': '{count} בלאָקן דופּליקירט, אָנהייבנדיק פֿון פּאָזיציע {position}',
  'a11y.searchResults': 'זוך־רעזולטאַטן: {count}',
  'a11y.allBlocksSelected': 'אַלע בלאָקן אויסגעקליבן. סך־הכּל: {count}',
  'toolNames.clearFormat': 'נעם אַראָפּ די פֿאָרמאַטירונג',
  'searchTerms.citation': 'ציטירונג',
  'tools.callout.addEmoji': 'צולייגן בילדל',
  'tools.callout.filterEmojis': 'זוכן עמאָדזשיס…',
  'tools.callout.noEmojisFound': 'קיין עמאָדזשיס נישט געפֿונען',
  'tools.callout.pickRandom': 'קלײַבן אַ צופֿעליקן עמאָדזשי',
  'tools.callout.emojiCategoryPeople': 'שמייכל־פּנימער און מענטשן',
  'tools.code.searchLanguage': 'זוכן שפּראַכן…',
  'searchTerms.pre': 'פֿאָרויס־פֿאָרמאַטירט',
  'toolNames.audio': 'אַודיאָ',
  'tools.link.removeLink': 'נעם אַראָפּ דעם לינק',
  'tools.link.linkTitle': 'לינק־טעקסט',
  'tools.image.alignmentLeftAria': 'אויסגלײַכן לינקס',
  'tools.image.alignmentCenterAria': 'אויסגלײַכן אין צענטער',
  'tools.image.alignmentRightAria': 'אויסגלײַכן רעכטס',
  'tools.image.viewFullscreen': 'ווייַזן אויפֿן פֿולן עקראַן',
  'tools.image.cancelUpload': 'אָפּזאָגן דאָס אַרויפֿלאָדן',
  ...
  'tools.image.errorDefaultMessage': 'דאָס בילד האָט זיך נישט געקענט לאָדן פֿון דעם URL. פּרוּווט אַן אַנדער מקור אָדער לאָדט די טעקע ווידער אַרויף.',
  'tools.image.emptyUpload': 'אַרויפֿלאָדן',
  'tools.image.emptyOrDropHere': 'אָדער שלעפּ אַ בילד אַהער',
  'tools.image.emptyDropToUpload': 'שלעפּ אַהער צו אַרויפֿלאָדן',
  'tools.image.emptyUrlPlaceholder': 'קלעפּ אַרײַן אַ בילד־URL…',
  'tools.image.cropRatioOval': 'אָוואַל',
  'tools.file.emptyUpload': 'אַרויפֿלאָדן',
  'tools.file.emptyDropHint': 'אָדער שלעפּ אַ טעקע אַהער',
  'tools.file.emptyDropToUpload': 'שלעפּ אַהער צו אַרויפֿלאָדן',
  'tools.file.emptyUrlPlaceholder': 'קלעפּ אַרײַן אַ טעקע־URL…',
  'tools.file.cancelUpload': 'אָפּזאָגן דאָס אַרויפֿלאָדן',
  'tools.file.uploadProgress': 'פֿאָרשריט בײַם אַרויפֿלאָדן',
  'tools.file.errorUploadFailed': 'דאָס אַרויפֿלאָדן איז דורכגעפֿאַלן',
  'tools.file.previewClose': 'פֿאַרמאַכן דעם פֿאָרויסבליק',
  'tools.file.previewRaw': 'מקור',
  'tools.video.alignmentLeft': 'אויסגלײַכן לינקס',
  'tools.video.alignmentCenter': 'אויסגלײַכן אין צענטער',
  'tools.video.alignmentRight': 'אויסגלײַכן רעכטס',
  'tools.video.errorUploadFailed': 'דאָס אַרויפֿלאָדן איז דורכגעפֿאַלן',
  'tools.video.emptyUpload': 'אַרויפֿלאָדן',
  'tools.video.emptyOrDropHere': 'אָדער שלעפּ אַ ווידעא אַהער',
  'tools.video.emptyDropToUpload': 'שלעפּ אַהער צו אַרויפֿלאָדן',
  'tools.video.emptyUrlPlaceholder': 'קלעפּ אַרײַן אַ ווידעאָ־URL…',
  'tools.audio.alignmentLeft': 'אויסגלײַכן לינקס',
  'tools.audio.alignmentCenter': 'אויסגלײַכן אין צענטער',
  'tools.audio.alignmentRight': 'אויסגלײַכן רעכטס',
  'tools.audio.replace': 'אויסבייטן אַודיאָ',
  'tools.audio.errorUploadFailed': 'דאָס אַרויפֿלאָדן איז דורכגעפֿאַלן',
  'tools.audio.titlePlaceholder': 'טרעק־טיטל',
  'tools.audio.emptyAddAudio': 'לייג צו אַודיאָ',
  'tools.audio.emptyUpload': 'אַרויפֿלאָדן',
  'tools.audio.emptyOrDropHere': 'אָדער שלעפּ אַן אַודיאָ־טעקע אַהער',
  'tools.audio.emptyDropToUpload': 'שלעפּ אַהער צו אַרויפֿלאָדן',
  'tools.audio.emptyUrlPlaceholder': 'קלעפּ אַרײַן אַן אַודיאָ־URL…',
  'tools.audio.emptyUrlAria': 'אַודיאָ־URL',
  'tools.audio.emptySourceAria': 'אַודיאָ־מקור',
  'tools.audio.coverUpload': 'אַרויפֿלאָדן',
  'tools.audio.coverOrDropHere': 'אָדער שלעפּ אַ בילד אַהער',
  'tools.audio.coverDropToUpload': 'שלעפּ אַהער צו אַרויפֿלאָדן',
  'tools.audio.coverUrlPlaceholder': 'קלעפּ אַרײַן אַ בילד־URL…',
  'tools.audio.coverSourceAria': 'הילע־מקור',
  'tools.database.duplicateView': 'דופּליקירן',
  'tools.database.addView': 'לייג צו אַן אויסשטעל',
  'tools.database.viewTypeListDescription': 'ווײַז זאַכן אין אַ פּשוטער ליסטע',
  'tools.database.propertyTypeSelect': 'אויסקלײַב',
  'tools.database.propertyTypeMultiSelect': 'מערפֿאַכער אויסקלײַב',
  'tools.database.propertyTypeCheckbox': 'טשעקבאָקס',
  'tools.database.listView': 'ליסטע־אויסשטעל',
  'toolNames.embed': 'עמבעד',
  'tools.bookmark.loading': 'לינק־פֿאָרויסבליק לאָדט זיך…',
  'tools.embed.empty': 'קיין עמבעד־לינק',
  'tools.embed.captionPlaceholder': 'שרײַב אַן אונטערקעפּל…',
  'tools.embed.urlPlaceholder': 'קלעפּ אַרײַן אַ לינק צו עמבעדן…',
  'tools.embed.urlSubmit': 'עמבעד דעם לינק',
  'tools.embed.invalidUrl': 'מען קען נישט עמבעדן דעם לינק',
  'tools.linkPaste.embed': 'שאַף אַן עמבעד',
  'tools.linkPaste.embedVideo': 'עמבעד אַ ווידעאָ פֿון {provider}',
  'tools.linkPaste.embedAudio': 'עמבעד אַודיאָ פֿון {provider}',
  'tools.linkPaste.embedImage': 'עמבעד אַ בילד פֿון {provider}',
  'tools.linkPaste.embedSocial': 'עמבעד אַ פּאָסט פֿון {provider}',
  'tools.linkPaste.embedDocument': 'עמבעד אַ דאָקומענט פֿון {provider}',
  'tools.linkPaste.embedTable': 'עמבעד אַ טאַבעלע פֿון {provider}',
  'tools.linkPaste.embedForm': 'עמבעד אַ פֿאָרמולאַר פֿון {provider}',
  'tools.linkPaste.embedCode': 'עמבעד קאָד פֿון {provider}',
  'tools.linkPaste.embedDesign': 'עמבעד אַ דיזײַן פֿון {provider}',
  'tools.linkPaste.embedChart': 'עמבעד אַ דיאַגראַמע פֿון {provider}',
  'tools.linkPaste.embedMap': 'עמבעד אַ מאַפּע פֿון {provider}',
  'tools.linkPaste.embedCalendar': 'עמבעד אַ קאַלענדאַר פֿון {provider}',
  'notifier.dismiss': 'פֿאַרמאַכן',
  'tools.video.seek': 'שפּיל־פּאָזיציע',
  'tools.video.toggleTimeDisplay': 'בײַטן צווישן פֿאַרגאַנגענער און פֿאַרבליבענער צײַט',
  'tools.video.on': 'אײַן',
  'tools.video.off': 'אויס',
  'tools.video.ctxStats': 'שפּיל־סטאַטיסטיק',
...
const LOCALIZED_EMOJI_CATEGORY_SCOPE = {
  ...
  yi: ['שמייכל־פּנימער און מענטשן', 'בעלי־חיים און נאַטור', 'עסן און טרינקען', 'רײַזן און ערטער'],
...
describe('translation guideline corpus integrity', () => {
  ...
  it('uses the independently adjudicated Yiddish correction oracle', () => {
    const messages = readLocale('yi').messages;
    const actual = Object.fromEntries(
      Object.keys(YIDDISH_REVIEWED_EXPECTATIONS).map(key => [
        key,
        messages[key],
      ])
    );
