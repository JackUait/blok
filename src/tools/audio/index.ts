...
export class AudioTool implements BlockTool {
  ...
  private resultDelta(result: UploadResult, file?: File): Partial<AudioData> {
  ...
  private showResult(result: UploadResult, file?: File): void {
    this.data = {
      ...this.data,
      url: result.url,
  ...
  private renderLoading(): void {
    ...
    const statusLabel = this.lastFileName === null
      ? tr(this.api.i18n, 'tools.audio.uploading', 'Uploading…')
      : undefined;
