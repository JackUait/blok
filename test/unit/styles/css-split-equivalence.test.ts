...
describe('main.css split — cascade-preserving equivalence', () => {
  ...
  it('total local CSS byte size stays within +2% of the pre-split baseline', () => {
    ...
    // layer (evenodd clip paths and a shade copy of each form) the faceted star and the cratered moon add 2,532 bytes in presence.css.
    const PRESENCE_TONAL_GLYPHS_BYTES = 2_532;
