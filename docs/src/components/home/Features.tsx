...
const ExtensibleViz: React.FC = () => {
  ...
  <div aria-hidden="true" className="relative h-full min-h-[150px] w-full">
    ...
    <div ref={cardRef} className="absolute left-[6%] top-[10px] w-[145%] overflow-hidden rounded-2xl border border-border/60 bg-card shadow-[0_24px_55px_-14px_rgba(0,0,0,0.25)]">
