 ...
 *
 * The rw-removed/rw-added hooks are inert here — they only animate under a
 * `.rewrite-live` ancestor (the hero's RewritePreview plays the rewrite).
 */
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1">
      <div className="flex items-start gap-2.5 rounded-lg bg-destructive/[0.06] px-2.5 py-1.5">
        ...
        <code className="rw-removed min-w-0 break-all font-mono text-xs leading-5 text-muted-foreground line-through decoration-destructive/40">{removed}</code>
      </div>
      <div className="rw-added flex items-start gap-2.5 rounded-lg bg-foreground/[0.04] px-2.5 py-1.5">
